...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,039 | 🐛 105 | 📅 2026-08-21 [![Build Status](https://app.travis-ci.com/sporto/awesome-elm.svg?branch=master)](https://app.travis-ci.com/sporto/awesome-elm)

A community driven list of useful Elm tutorials, libraries and software.
Inspired by the [awesome](#more-awesome) list thing. Feel free to [improve](https://github.com/sporto/awesome-elm/blob/master/CONTRIBUTION.md) ⭐ 3,686 | 🐛 4 | 📅 2026-07-21 this list.
...
* [Contribution Guidelines](https://github.com/sporto/awesome-elm/blob/master/CONTRIBUTION.md) ⭐ 3,686 | 🐛 4 | 📅 2026-07-21
...
* [Codings hints](https://github.com/elm/compiler/tree/master/hints) ⭐ 7,899 | 🐛 304 | 🌐 Haskell | 📅 2026-08-26 - A list of README files by Evan.
* [Architecture Tutorial](https://github.com/evancz/elm-architecture-tutorial) ⭐ 4,165 | 🐛 10 | 🌐 Elm | 📅 2019-12-30 - How to create modular Elm code that scales nicely with your app.
...
* [OpenApi Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,713 | 🐛 5,722 | 🌐 Java | 📅 2026-09-01 - Generate OpenApi types for Elm.
* [Quicktype](https://github.com/quicktype/quicktype) ⭐ 13,847 | 🐛 233 | 🌐 TypeScript | 📅 2026-09-01 - Generate JSON decoders and encoders from JSON
...
* [create-elm-app](https://github.com/halfzebra/create-elm-app) ⭐ 1,677 | 🐛 54 | 🌐 JavaScript | 📅 2026-08-30 - Create Elm apps with no build configuration.
* [elm-live](https://github.com/wking-io/elm-live) ⭐ 1,068 | 🐛 52 | 🌐 JavaScript | 📅 2022-06-18 - A flexible dev server for Elm. Live reload included.
...
* [elm-webpack-starter](https://github.com/moarwick/elm-webpack-starter) ⭐ 851 | 🐛 10 | 🌐 JavaScript | 📅 2021-12-12 - A simple Webpack setup for writing Elm apps.
* [elm-app-boilerplate](https://github.com/gkubisa/elm-app-boilerplate) ⭐ 120 | 🐛 4 | 🌐 Elm | 📅 2018-01-14 - A fully-featured base project for Elm apps: Webpack, HMR, ES6, JS and Elm tests, Semantic UI, sample code and more.
* [elm-new](https://github.com/simonewebdesign/elm-new) ⭐ 81 | 🐛 0 | 🌐 Shell | 📅 2020-06-05 - Generate initial project scaffolding based on a template.
* [elmkit](https://github.com/khusnetdinov/elmkit) ⭐ 52 | 🐛 4 | 🌐 Elm | 📅 2026-05-07 - A lightweight Brunch based setup for web app. Includes Brunch, Hot Module Replacement, Elm, Scss, Elm tests.
...
* [Elm Analyse](https://github.com/stil4m/elm-analyse) ⭐ 416 | 🐛 75 | 🌐 Elm | 📅 2023-04-19 - Linter for the Elm programming language.
* [Elm Review](https://github.com/jfmengels/elm-review) ⭐ 283 | 🐛 19 | 🌐 Elm | 📅 2026-06-05 - Code reviewer for the Elm programming language.
...
* [elm-compiler](https://github.com/elm/compiler) ⭐ 7,899 | 🐛 304 | 🌐 Haskell | 📅 2026-08-26 - The official Elm compiler.
...
* [grunt-elm](https://github.com/rtfeldman/grunt-elm) ⭐ 20 | 🐛 4 | 🌐 JavaScript | 📅 2018-03-24 - Grunt plugin that compiles Elm files to JavaScript.
...
* [Elm Format](https://github.com/avh4/elm-format) ⭐ 1,333 | 🐛 236 | 🌐 Haskell | 📅 2025-06-19 - Automatic Elm code formatter adhering to [Elm Style Guide](https://elm-lang.org/docs/style-guide).
...
* [Elm Doc Preview](https://github.com/dmy/elm-doc-preview) ⭐ 137 | 🐛 15 | 🌐 Elm | 📅 2026-03-30 - Elm offline documentation previewer.
* [elm-posix](https://github.com/albertdahlin/elm-posix) ⭐ 93 | 🐛 5 | 🌐 Elm | 📅 2021-10-18 - Write CLI programs using Elm
...
* [emacs-elm-mode](https://github.com/jcollard/elm-mode) ⭐ 382 | 🐛 14 | 🌐 Emacs Lisp | 📅 2025-04-01 - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.
...
* [Elm Language Server](https://github.com/elm-tooling/elm-language-server#sublime) ⭐ 445 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-01 - Language server implementation for Elm
...
* [emmet-vim](https://github.com/mattn/emmet-vim) ⭐ 6,467 | 🐛 132 | 🌐 Vim Script | 📅 2026-03-24 - Markup expansion with elm support.
...
* [theJian/elm.vim](https://github.com/theJian/elm.vim) ⭐ 0 | 🐛 0 | 🌐 Vim script | 📅 2018-06-12 - Elm syntax highlighting. Use with [ale or Neoformat for Neovim](https://github.com/avh4/elm-format/issues/610) ⭐ 1,333 | 🐛 236 | 🌐 Haskell | 📅 2025-06-19 since ElmCast/elm-vim does not support Elm 0.19.
...
* [Elm SPA Example](https://rtfeldman.github.io/elm-spa-example/) - Full stack Elm app w/ CRUD operations, Auth, routing, pagination and more. [Code](https://github.com/rtfeldman/elm-spa-example) ⭐ 3,305 | 🐛 50 | 🌐 Elm | 📅 2023-11-03 / [Article](https://dev.to/rtfeldman/tour-of-an-open-source-elm-spa) / [Video](https://youtu.be/RN2_NchjrJQ)
...
* [Collection of examples](https://github.com/halfzebra/elm-examples) ⭐ 210 | 🐛 1 | 🌐 JavaScript | 📅 2019-02-04 - A collection of examples with advanced techniques for real-world Elm apps.
* [Elm Narrative Engine](https://github.com/jschomay/elm-narrative-engine) ⭐ 139 | 🐛 0 | 🌐 Elm | 📅 2023-08-18 - A framework for building interactive fiction style stories in Elm. Detailed example [elmnarrativeengine.com](https://elmnarrativeengine.com) shows how to build a "chose your own adventure" game; perfect for beginners. **Elm v.0.19**
...
* [Spotify Mapper](https://github.com/FidelisClayton/elm-spotify-mapper) ⭐ 65 | 🐛 13 | 🌐 Elm | 📅 2023-03-04 - Elm app integrated with Spotify Api to search and explore new artists.
* [TodoMVC/Firebase](https://github.com/ThomasWeiser/todomvc-elmfire) ⭐ 61 | 🐛 1 | 🌐 Elm | 📅 2016-06-16 - Fork of TodoMVC demonstrating start-app, [The Elm Architecture](https://github.com/evancz/elm-architecture-tutorial) ⭐ 4,165 | 🐛 10 | 🌐 Elm | 📅 2019-12-30 and Firebase as backend.
...
* [elm-games](https://github.com/rofrol/elm-games) ⭐ 146 | 🐛 2 | 📅 2023-04-05 - An excellent list of games made in Elm
...
* [Companies using Elm](https://github.com/jah2488/elm-companies) ⭐ 494 | 🐛 1 | 🌐 Elm | 📅 2026-08-23 - A list of companies using Elm in production.
...
* [Iced](https://github.com/hecrj/iced) ⭐ 31,409 | 🐛 490 | 🌐 Rust | 📅 2026-09-01 - A cross-platform GUI library for Rust, inspired by Elm
* [Hyperapp](https://github.com/jorgebucaran/hyperapp) ⭐ 19,197 | 🐛 14 | 🌐 JavaScript | 📅 2025-03-20 - A library that provide The Elm Architecture in JavaScript.
* [Roc](https://github.com/roc-lang/roc) ⭐ 6,025 | 🐛 194 | 🌐 Zig | 📅 2026-09-01 - A language that targets WebAssembly and machine code inspired by Elm.
* [Miso](https://github.com/dmjio/miso) ⭐ 2,433 | 🐛 21 | 🌐 Haskell | 📅 2026-09-01 - A library that provides The Elm Architecture in Haskell.
* [Lustre](https://github.com/lustre-labs/lustre) ⭐ 2,427 | 🐛 22 | 🌐 Gleam | 📅 2026-08-23 - A library that provides The Elm Architecture in Gleam.
...
* [Fabulous](https://github.com/fsprojects/Fabulous) ⭐ 1,270 | 🐛 9 | 🌐 F# | 📅 2026-09-01 - F# Functional App Development, using declarative dynamic UI
...
* [Flame](https://github.com/easafe/purescript-flame) ⭐ 320 | 🐛 7 | 🌐 PureScript | 📅 2026-08-26 - A library that provides The Elm Architecture in PureScript.
...
* [elm-posix](https://github.com/albertdahlin/elm-posix) ⭐ 93 | 🐛 5 | 🌐 Elm | 📅 2021-10-18 - Write CLI programs using Elm
* [elmish-wasm](https://github.com/Chadtech/elmish-wasm) ⭐ 18 | 🐛 0 | 🌐 Haskell | 📅 2018-02-17 A POC for compiling elm to Web Assembly
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,039 | 🐛 105 | 📅 2026-08-21 by [**@sindresorhus**](https://github.com/sindresorhus)
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,639 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02 by [**@bayandin**](https://github.com/bayandin)
